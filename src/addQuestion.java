...
public class addQuestion extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(testType.equals("single")){
			String question1=request.getParameter("question1")==null?"null":request.getParameter("question1");
			String question2=request.getParameter("question2")==null?"null":request.getParameter("question2");
			String question3=request.getParameter("question3")==null?"null":request.getParameter("question3");
			String question4=request.getParameter("question4")==null?"null":request.getParameter("question4");
			String answer=request.getParameter("answer")==null?"E":request.getParameter("answer");
			...
			String answer=request.getParameter("answer")==null?"null":request.getParameter("answer");
