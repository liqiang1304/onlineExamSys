...
public class Retests extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String sql = "select * from student_recoder where student_id='" + userId +"' and test_id='" + testId +"'";
		...
		sql = "update personinfo set passTest="+passTest+", socre="+socre+" where id='"+ userId +"'";
		stmt.executeUpdate(sql);
