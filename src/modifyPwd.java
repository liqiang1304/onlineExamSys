...
public class modifyPwd extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			if(rs.getString("password").equals(pwdConfirm)&&newPwd.equals(newConPwd)){
				sql = "update personinfo set password='"+newPwd+"' where id='"+userid+"'";
				...
				if(!newPwd.equals(newConPwd)){
					...
					request.getRequestDispatcher("../info/modifyPwd.jsp").forward(request, response);
				}
