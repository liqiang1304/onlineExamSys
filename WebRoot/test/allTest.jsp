...
<% 
 ...
 String sql="select * from test_title order by add_time desc";
  ...
  <div class="main">
    <div class="left">
      <div class="box_1">
        ...
        <div class="left_news">
          <ul>
            <li><a href="../news/campusNews.jsp">学校信息</a></li>
            <li><a href="../news/schoolNews.jsp">学院信息</a></li>
      ...
      <div class="box_1" style="margin:0px;">
        ...
        <div class="left_nr">
          <ul>
            <li><a href="allTest.jsp">所有考试</a></li>
          </ul>
        </div>
      </div>
    </div>
